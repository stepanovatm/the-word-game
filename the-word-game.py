...
count = 0
words = {\
         'огород', 'самолёт', 'компьютер', 'собака', 'поляна', 'скрепка', 'деревня', 'библиотека', 'природа', 'алфавит', 'поместье',\
         'животное', 'археология', 'бабушка', 'документ', 'словосочетание', 'велосипед', 'автомобиль', 'аэропорт', 'аквариум', 'автобус',\
         'экскаватор', 'белка', 'бабочка', 'время', 'поход', 'работа', 'улица', 'дорога', 'слово'}
print('Здравствуйте!')
print('Вы бы хотели сыграть в игру?(Если хотите, то напишите "да", если не хотите - "нет".)')
otvet = input()
if otvet == 'да':
    while otvet == 'да' and countwords <= 30:
        countwords += 1
